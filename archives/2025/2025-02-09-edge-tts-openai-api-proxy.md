...
1. 访问 https://your-domain-name.com/v1/audio/speech，确认服务是否正常运行。浏览器显示如下信息，则表示运行成功！

![Edge TTS API 运行成功](/static/2025/2025-02-09-edge-tts-openai-api-proxy_001.png)
...
Nginx 和 Certbot 的自动续期服务在 VPS 重启后会自动运行，前提是你已经正确配置了它们。以下是详细说明：
...
![Edge TTS 语音支持列表](/static/2025/2025-02-09-edge-tts-openai-api-proxy_002.png)
