...
4. 文本清洗与精修
   ...
   - 拼写:修正明显的 ASR 识别错误(单词错误、拼写错误、单词发音相同，但是是错误的单词，放入句子中明显不正确的)
   - 格式:修正英文的大小写规范(句首大写、专有名词大写)

5. 修复后的srt文件，要进行复查，避免时间戳，单词，句子合并等错误的发生！
...
【输出文件名】
请将输出的文件名直接保存为01.srt, 02.srt...... 去除transcription_前缀！
```
