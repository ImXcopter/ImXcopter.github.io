...
本程序实现的效果：数码管从0加到255，相应的LED小灯以二进制的状态显示当前的数值。
由于LED小灯只有8个，也就相当于可以表达8位的二进制数值，即1个字节的二进制数值状态。所以我们的程序是从十进制数0开始，每秒加1个数，直到加到255。
本程序使用定时器1中断来刷新数码管和LED小灯，并精确计时。代码已经在KST-51 v1.3.2开发板验证通过。
![](/static/2023/2023-03-14-51mcu-led-binary-display_001.jpg)
