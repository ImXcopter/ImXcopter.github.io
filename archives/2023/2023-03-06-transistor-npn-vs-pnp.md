...
![三极管结构](/static/2023/2023-03-06-transistor-npn-vs-pnp_001.jpg)
...
![NPN与PNP结构](/static/2023/2023-03-06-transistor-npn-vs-pnp_002.jpg)
...
上图中，横向左侧的引脚叫做基极b，有一个箭头的是发射极e，剩下的一个引脚就是集电极c。

对于NPN型三极管在用于开关状态时，一般都是发射极接地，集电极接高电平，基极接控制信号。

对于PNP型三极管在用于开关状态时，一般都是发射极接高电平，基极接控制信号。三极管导通时，电流从发射极流向集电极。

三极管有截止、放大、饱和三种工作状态。放大状态主要应用于模拟电路中，且用法和计算方法也比较复杂，我们暂时用不到。而数字电路主要使用的是三极管的开关特性，只用到了截止与饱和两种状态。
