...
![BBR安装菜单](/static/2023/2023-03-01-linux-bbr-script_001.png)

以安装BBR plus为例，输入数字2来安装。重启VPS如图：

![重启VPS](/static/2023/2023-03-01-linux-bbr-script_002.png)

- 安装成功，重启VPS之后我们重新连接服务器。输入下列指令来启用其BBR plus。
...
![启用加速](/static/2023/2023-03-01-linux-bbr-script_003.png)

- 如出现如图所示的信息，则表明BBR的加速功能已成功打开。

![BBR加速成功](/static/2023/2023-03-01-linux-bbr-script_004.png)
